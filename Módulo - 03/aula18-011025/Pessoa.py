...
organizada, implemente um método "getter" para o nome. Um "getter" é uma forma
de obter a informação de um objeto."""
...
carlos = professor.get_nome()

print(f"O nome do professor é: {carlos}.")
print(f"A idade do professor é: {professor.idade}")